...
(function () {
	...
	/*
	 * 值得保留的文本所含的关键词。命中任一即保留该段。
	 *
	 * 除学费外必须包含地址类词：院校页要填 region / city，
	 * 没有所在地就无法发布（也拿不到「東京 日本語学校」这类地域长尾）。
	 * 最初这份列表只抄了学费相关的词，结果在 KLA 上抓了两页都没拿到校舎信息。
	 */
	var KEYWORDS = [
		// 费用
		...
		'定員', '募集', '入学時期', '出願', '在籍', '学生数',
		// 日语水平
		'日本語能力', 'JLPT', 'N1', 'N2', 'N3', 'N4', 'N5', 'EJU',
		// 所在地・校舎（发布院校页的必需信息）
		'住所', '所在地', 'アクセス', '最寄', '徒歩', '校舎', 'キャンパス',
		'東京', '大阪', '京都', '名古屋', '福岡', '横浜', '神戸', '札幌',
		'都', '道', '府', '県', '区', '市',
		// 英文
		'tuition', 'fee', 'admission', 'JPY', 'address', 'campus', 'access'
	];
	...
	var LINK_WORDS = [
		'学費', '学费', '費用', '授業料', '料金', '納入',
		'募集', '出願', '入学', '願書', 'コース', '課程',
		// 学校概要・所在地类页面也要列出 —— 只按学费关键词筛，
		// 会把「アクセス」「学校案内」这类含校舎信息的页面全部滤掉。
		'アクセス', '学校案内', '学園案内', '校舎', '概要', '施設',
		'tuition', 'fee', 'cost', 'admission', 'apply', 'course', 'program',
		'access', 'about', 'school', 'campus', 'location'
	];
